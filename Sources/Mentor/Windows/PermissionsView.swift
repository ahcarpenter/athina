        ...
        VStack(alignment: .leading, spacing: 16) {
            HStack(alignment: .top, spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text("Mentor watches what you are doing so it can understand your work. What it senses stays on this Mac, in a journal you control. It connects only to api.anthropic.com, and only after you save an API key.")
            ...
            Text("Idle detection needs no permission. If a permission you turned on in System Settings still shows as not granted after a few seconds, quit and reopen Mentor.")
                .font(.callout)
                .foregroundStyle(.secondary)
                .fixedSize(horizontal: false, vertical: true)
