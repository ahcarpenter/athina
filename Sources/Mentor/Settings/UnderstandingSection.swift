    ...
    var body: some View {
        ...
        Section {
            ...
            DurationRow(
                ...
                help: "Every mentor call also rewrites the understanding, at no extra cost. After at least this much active use with no mentor call, Mentor makes a refresh call of its own."
            )
            IntRow(
