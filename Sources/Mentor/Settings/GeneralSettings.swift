...
/// The General pane: whether Mentor offers suggestions and how they are
        ...
        Form {
            Section {
                Toggle(isOn: $state.settings.mentor.enabled) {
                    ...
                    Text("Mentor points out a more helpful way to do what you are doing when it notices one.")
                }
                PercentRow(
...
struct NeverRulesSection: View {
    ...
    var body: some View {
        ...
        Section {
            ...
            Text("Remove a category to let Mentor suggest it in that app again.")
        }
    }
}
