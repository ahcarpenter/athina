...
private struct ClockAdvanceField: View {
    ...
    var body: some View {
        ...
        .font(.callout)
        .controlSize(.small)
        .help("Moves the replay's clock ahead at once, as if that much time went by with the Mac awake in the mode Athina is in: waits due in it end, and while watching it counts as active use.")
    }
