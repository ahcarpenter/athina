...
struct PermissionsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Idle detection needs no permission. If a permission you turned on in System Settings still shows as not granted after a few seconds, quit and reopen Athina.")
                .font(.callout)
                .foregroundStyle(.secondary)
                .fixedSize(horizontal: false, vertical: true)
