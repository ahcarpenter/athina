...
struct JournalSettings: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("Every observation, thumbnail, event, suggestion, follow-up question, and model call record is deleted, along with Athina's understanding of what you are working toward. You can't undo this action.")
        }
        .task {
    ...
    var body: some View {
        ...
        Form {
            ...
            Section {
                ...
                Text("While one of these apps is frontmost, Athina captures nothing, reads no window or element, and journals only that the app was excluded.")
            }
        }
    }
}
