...
struct AppAccessibility {
  ...
  struct Query {
    ...
    func matches(_ node: Node) -> Bool {
      ...
      if let label {
        return [node.label, node.title].contains {
  ...
  static let windowButtons: Set<String> = [
  ...
  static func frame(of element: AXUIElement) -> CGRect {
    ...
    if let position = value(element, kAXPositionAttribute),
  ...
  static func globalFrame(of screenRect: CGRect) -> CGRect {
    CGRect(
      x: screenRect.minX,
      y: primaryHeight - screenRect.maxY,
  ...
  static func screenRect(of globalFrame: CGRect) -> CGRect {
    CGRect(
      x: globalFrame.minX,
      y: primaryHeight - globalFrame.maxY,
