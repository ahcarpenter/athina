...
/// What Mentor believes the user is working toward and what has happened so
...
public struct Understanding: Codable, Equatable, Sendable {
    ...
    public init(goals: [Goal] = [], timeline: [String] = [], mentorHistory: [String] = [], openConcerns: [String] = []) {
        self.goals = goals
    ...
    public func normalized() -> Understanding {
        ...
        return Understanding(
            goals: goals
                ...
                .sorted { $0.confidence != $1.confidence ? $0.confidence > $1.confidence : $0.goal < $1.goal }
    ...
    /// The goal Mentor is most confident about: the one a suggestion is judged
    ...
    public var promptBlock: String {
        ...
        appendSection(&lines, title: "What you have already told them, and their answer:", items: mentorHistory)
