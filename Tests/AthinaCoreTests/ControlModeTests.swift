...
@Suite struct ControlModeTests {
    ...
    @Test func theDirectoryMustBeTheHarnesssOwn() {
        let cases: [(ControlDirectory, String)] = [
            ...
            (ControlDirectory(kind: .directory, permissions: 0o755, secret: secret), "0700), not 755"),
            (ControlDirectory(kind: .directory, permissions: 0o710, secret: secret), "0700), not 710"),
