...
@Suite struct ReplayClientTests {
    ...
    private func temporaryDirectory() -> URL {
        FileManager.default.temporaryDirectory.appendingPathComponent("mentor-replay-\(UUID().uuidString)", isDirectory: true)
    }
    ...
    func launchFlagsChooseTheMode(arguments: [String], expected: ModelClientMode) {
        let mode = ModelClientMode(arguments: ["Mentor"] + arguments, defaultRecordingDirectory: URL(fileURLWithPath: "/default", isDirectory: true))
