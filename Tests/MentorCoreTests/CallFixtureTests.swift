...
@Suite struct CallFixtureTests {
    ...
    static func request(text: String = "App: TextEdit", image: Bool = false) -> MessagesRequest {
        ...
        return MessagesRequest(
            ...
            maxTokens: 6000,
            system: [SystemBlock(text: "You are Mentor.")],
    ...
    private func temporaryDirectory() -> URL {
        FileManager.default.temporaryDirectory.appendingPathComponent("mentor-fixtures-\(UUID().uuidString)", isDirectory: true)
    }
    ...
    @Test func theKeyIsRedactedWhereverItAppears() throws {
        ...
        #expect(untouched.contains("You are Mentor."))
